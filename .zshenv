...
export ANSIBLE_HOME="$_CONFIG_HOME/ansible"
export ANSIBLE_CONFIG="$_CONFIG_HOME/ansible.cfg"
export ANSIBLE_GALAXY_CACHE_DIR="$_CACHE_HOME/ansible/galaxy_cache"
# export DOCKER_CONFIG="$_CONFIG_HOME/docker"
# export MACHINE_STORAGE_PATH="$_DATA_HOME/docker-machine"
